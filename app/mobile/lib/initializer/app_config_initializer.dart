...
extension on Flavor {
  String get backendUrl => switch (this) {
        ...
        Flavor.stg => 'https://torchro-app-backend-ysop674t6q-an.a.run.app',
        Flavor.prod => 'https://api.app.torchro.fit',
      };

  String get websiteUrl => switch (this) {
        Flavor.dev => Env.websiteUrl,
        Flavor.stg => 'https://staging.torchro.fit',
        Flavor.prod => 'https://torchro.fit',
      };
}
